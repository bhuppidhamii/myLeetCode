<h2><a href="https://www.geeksforgeeks.org/problems/maximum-depth-of-binary-tree/1?page=1&company=Amazon&status=unsolved&sortBy=accuracy">Maximum Depth Of Binary Tree</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a binary tree, find its <strong>maximum</strong>&nbsp;<strong>depth</strong>.<br>A binary tree's maximum depth is the number of nodes along the longest path from the root node down to the farthest leaf node.</span></p>
