...
<pre><span style="font-size: 18px;"><strong>Input:</strong> arr[] = [2, 1, 3, 5, 4, 6]<br><strong>Output:</strong> 3<br><strong>Explanation:</strong> a</span><span style="font-size: 18px;">rr[1], arr[3], arr[5] can be found.</span></pre>
